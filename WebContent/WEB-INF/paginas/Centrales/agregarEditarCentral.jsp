...
<fieldset id="" class="">
	...
	<div>
		 ...
		 <div class="ayuda_g"><a href="#" ></a><div class="tooltip">Nombre de la tabla, donde se poblarán los datos provenientes de los archivos generados por la central</div></div>
	</div>
	<div class="clear"></div>
	<div>
		 ...
		 <div class="ayuda_g"><a href="#" ></a><div class="tooltip">Son los campos de la tabla de carga en crudo, que serán transferidos a la tabla de formato &uacute;nico "FORMATO_UNICO_ADI"</div></div>
	</div>
	<div class="clear"></div>
	<div>
